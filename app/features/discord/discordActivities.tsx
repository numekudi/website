...
export default function DiscordActivities({
  ...
  if (isLoading) {
    return (
      <div className="mt-4 space-y-3">
        <div className="h-[120px] flex items-center gap-4 p-4 border rounded-md bg-white/5 animate-pulse">
  ...
  if (!activities || activities.length === 0) {
    return (
      <div className="mt-4 space-y-3">
        <div className="h-[120px] flex items-center gap-4 p-4 border rounded-md bg-white/5">
    ...
    <div className="mt-4 space-y-3">
      {activities.map((a, i) => {
        ...
        return (
          <div
            key={i}
            className="h-[120px] flex items-center gap-4 p-4 border rounded-md bg-white/5"
            role="group"
